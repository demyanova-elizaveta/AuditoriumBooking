...
{
    /// <summary>
    /// Логика взаимодействия для AuditoriumForm.xaml
    /// </summary>
    public partial class AuditoriumForm : Window, INotifyPropertyChanged, IDataErrorInfo
    {
        public AuditoriumForm()
        {
            InitializeComponent();
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            else
            {
                ...
                ResourcesProvider.Current.Applications.Add(guid, new ApplicationInfo()
                {
                    ...
                    SpecifiedColors = new List<ScheduleInfo.KeyValuePair<DateTime, string>>()
                });
                ...
                Snackbar.MessageQueue.Enqueue("Добавление заявки...");
                Snackbar.MessageQueue.Enqueue("Заявка добавлена!", "Отменить", () => UndoAdding(guid));
